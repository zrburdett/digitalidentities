let input, inputtwo, inputthree, button, buttontwo, buttonthree, greetingtwo, greeting, grettingthree;
function setup(){
  ...
  greetingtwo = createElement('h2', 'how many letters in your last name?');
...
function backgroundshapes(){
	var s=inputtwo.value();
	var shapes=parseInt(s);
	push();
	stroke(16, 0, 227,0.5);
	for(let a=0; a<=10;a++)
		{
